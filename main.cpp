...
int main()
{
    ...
    std::string s = "753950001954,Doctor's Best Best Curcumin C3 Complex 1000mg Tablets - 120 Ct"; 
    items[0] = new UPCEntry(s);
    ...
    TwoHashTable *table = new TwoHashTable("D:\\Allen\\School\\CS 300\\Projects\\CS300_Assignment6\\test_data.csv", 3);
    cout << "-- sample run start --" << endl;
    cout << table->getStdDev() << endl;
